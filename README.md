...
| File | Description |
|------|-------------|
| `MCQ_Validation_Interface.html` | Interactive validation tool — open in your browser (all 200 questions are embedded, no separate file needed) |
| `20042026_expert_questions.json` | Raw question data (200 MCQs) — reference only; the HTML already contains this data |
| `README.md` | This file |
...
- **Online (recommended):** Open [https://cathiwi.github.io/mcq-validation-interface/MCQ_Validation_Interface.html](https://cathiwi.github.io/mcq-validation-interface/MCQ_Validation_Interface.html) in your browser.
- **Offline:** Download `MCQ_Validation_Interface.html` and double-click to open it in your browser (Chrome, Firefox, or Edge). No installation needed — everything runs locally.
...
### 3. Validate with 3 Quick Clicks
...
Your progress is **saved automatically** in your browser. You can close the tab, shut down your laptop, and come back later — everything will still be there. Just make sure to always use the **same browser** (and, if you use the online version, the same device).
